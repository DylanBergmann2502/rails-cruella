class CreateRodauth < ActiveRecord::Migration[8.0]
  def change
    ...
    create_table :account_jwt_refresh_keys, id: :serial do |t|
      t.references :account, null: false, foreign_key: true
      t.string :key, null: false, limit: 255
      t.datetime :deadline, null: false
    end
    
    add_index :account_jwt_refresh_keys, [:account_id, :key], unique: true
    add_index :account_jwt_refresh_keys, :deadline
  end
end
